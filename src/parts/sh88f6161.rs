// Auto-generated from GPT file for SH88F6161
// Source GPT SHA-256: 2f792bf351dbeb8ddab41f6b4aefd2a28a8551769daa0018e8ca32bf502bf79b
...
pub fn options() -> Options {
    IndexMap::from([
        ...
        ("OP_SINK", OptionInfo {
            ...
            editable: true,
            states: IndexMap::from([
                (0, "P0/P1 sink ability normal mode(default)"),
        ...
        ("OP_DRIVE", OptionInfo {
            ...
            editable: true,
            states: IndexMap::from([
                (0, "P3/P4 drive ability normal mode(default)"),
                (1, "P3/P4 drive ability large mode"),
            ]),
        }),
        ("OP_OSC", OptionInfo {
            byte_index: 2,
