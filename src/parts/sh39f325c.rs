// Auto-generated from GPT file for SH39F325C
// Source GPT SHA-256: be53ce5ad9ed3ae408820883df2f8de43cfc3a674ceca9715b4e50c263b1e20e
...
pub const PART: Part = Part {
    part_number: hex!("39f325c000"),
    chip_type: 0x02,
    custom_block: 0x02,
    product_block: 0x01,
    flash_size: 16384,
    eeprom_size: 512,
    default_code_options: &hex!("a0a00088"),
    code_option_mask: &hex!("e0f10000"),
    jtag_id: 0x083a,
    sector_size: 1024,
    option_byte_count: 4,
    security_level: 1,
...
pub fn options() -> Options {
    IndexMap::from([
        ...
        ("OP_LPDFLAG", OptionInfo {
            ...
            editable: true,
            states: IndexMap::from([
                (0, "LPD FLAG cannot be set when P1.3 used as analog input pin and LPD detect voltage is select as VDD"),
