// Auto-generated from GPT file for 77P1653A-16K*1
...
pub fn options() -> Options {
    IndexMap::from([
        ...
        ("OP_AHUM", OptionInfo {
            ...
            editable: true,
            states: IndexMap::from([
                (0, "Enable C32K humidity resistance function"),
                (1, "Disable C32K humidity resistance function"),
            ]),
        }),
