// Auto-generated from GPT file for SH79F2221
// Source GPT SHA-256: 745b57ec9693712333f97e988bca885c9a2b35a26619e7c3698b0728c65aef91
...
pub const PART: Part = Part {
    part_number: hex!("79f2221000"),
    chip_type: 0x07,
    custom_block: 0x03,
    product_block: 0x01,
    flash_size: 32768,
    eeprom_size: 1024,
    default_code_options: &hex!("2a00800000000086"),
    code_option_mask: &hex!("3fc030020000000f"),
    jtag_id: 0x2201,
    sector_size: 512,
    option_byte_count: 8,
    security_level: 4,
    ...
    IndexMap::from([
        ...
        (
            ...
            OptionInfo {
                ...
                states: IndexMap::from([
                    ...
                    (
                        15,
                        "Oscillator1 external clock(Input from P0.4), oscillator2 is disabled",
                    ),
                ]),
            },
        ),
        ...
        (
            ...
            OptionInfo {
                ...
                bits_end: 3,
                editable: true,
                states: IndexMap::from([(6, "2 x 512Bytes"), (7, "1 x 512Bytes"), (8, "0 Bytes")]),
            },
        ),
    ])
}
