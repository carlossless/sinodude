// Auto-generated from GPT file for SH79F9206
// Source GPT SHA-256: eba7c972d01e465ba0a3a0c8b93696ac7788023a32b7bc908fa5de28d9010134
...
pub const PART: Part = Part {
    part_number: hex!("79f9206000"),
    chip_type: 0x07,
    custom_block: 0x03,
    product_block: 0x01,
    flash_size: 32768,
    eeprom_size: 4096,
    default_code_options: &hex!("000000c000000080"),
    code_option_mask: &hex!("21e10f010100ff0f"),
    jtag_id: 0x9271,
    sector_size: 512,
    option_byte_count: 8,
    security_level: 4,
    ...
    IndexMap::from([
        ("OP_RST", OptionInfo {
            ...
            states: IndexMap::from([
                (0, "P2.7 used as RST pin"),
                (1, "P2.7 used as I/O pin"),
            ]),
        }),
        ("OP_P04-P01", OptionInfo {
            byte_index: 0,
            bits_start: 0,
            bits_end: 0,
            editable: true,
            states: IndexMap::from([
                (0, "Port0[4:1] sink ability normal mode"),
                (1, "Port0[4:1] sink ability large mode"),
            ]),
        }),
        ("OP_LVREN", OptionInfo {
            byte_index: 1,
        ...
        ("OP_IO", OptionInfo {
            ...
            editable: true,
            states: IndexMap::from([
                (0, "P0.7,P1.0-P1.2,P2.7,P3.0-P3.1 sink ability normal mode"),
                (1, "P0.7,P1.0-P1.2,P2.7,P3.0-P3.1 sink ability large mode"),
            ]),
        }),
        ("OP_OSC", OptionInfo {
            byte_index: 2,
