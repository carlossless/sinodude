// Auto-generated from GPT file for SH79F083B
// Source GPT SHA-256: 56127d9862168cbb4da7e3e5542e3a9743f388cf36c3ac3c7708e074834ff535
...
pub const PART: Part = Part {
    part_number: hex!("79f083a000"),
    chip_type: 0x02,
    custom_block: 0x02,
    product_block: 0x01,
    flash_size: 8192,
    eeprom_size: 512,
    default_code_options: &hex!("000100c8"),
    ...
    IndexMap::from([
        ...
        ("OP_OSC", OptionInfo {
            ...
            states: IndexMap::from([
                ...
                (3, "32.768kHz Crystal oscillator and Internal RC oscillator(16.6MHz)"),
