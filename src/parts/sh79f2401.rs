// Auto-generated from GPT file for SH79F2401
// Source GPT SHA-256: a4f3f8abb56da9e81ea4f1d68a71344f5e075378afeaa2369ffae61ed5a85838
...
pub const PART: Part = Part {
    part_number: hex!("79f2401000"),
    chip_type: 0x07,
    custom_block: 0x03,
    product_block: 0x01,
    flash_size: 64512,
    eeprom_size: 1024,
    default_code_options: &hex!("80000301"),
    code_option_mask: &hex!("e0e8e002"),
    jtag_id: 0x3213,
    sector_size: 512,
    option_byte_count: 4,
    security_level: 4,
        ...
        (
            ...
            OptionInfo {
                ...
                states: IndexMap::from([
                    ...
                    (4, "P2.0~P2.5 as PWM2/PWM21/PWM11/PWM1/PWM01/PWM0"),
                ]),
            },
        ),
        (
